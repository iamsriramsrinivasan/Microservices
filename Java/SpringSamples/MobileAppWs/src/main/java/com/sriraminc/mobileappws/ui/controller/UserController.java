package com.sriraminc.mobileappws.ui.controller;
...
import com.sriraminc.mobileppws.ui.model.request.UpdateUserDetailsRequestModel;
...
public class UserController {
	...
	public String getUsers(@RequestParam(value = "page", defaultValue = "1") int page,
		...
		return "getusers was called with the following RequestParam " + "page = " + page + " limit = " + limit
				+ " Sort = " + sort;
	}
